    ...
    <>
      ...
      >
        <nav className="max-w-screen-xl px-2 md:px-6 sm:px-8 lg:px-16 mx-auto grid grid-flow-col py-3 sm:py-4">
          <Link href="/">
            <div className="col-start-1 col-end-6 sm:col-start-1 sm:col-end-4 md:col-start-1 md:col-end-4 lg:col-start-1 lg:col-end-4 flex items-center">
              <LogoSkillGarage className="lg:h-16 md:h-14 sm:h-14 xs:h-11" />
            </div>
          </Link>
          <ul className="hidden lg:flex col-start-4 col-end-8 text-black-500  items-center">
            ...
            <div className="relative inline-block">
              ...
              {isDropdownOpen && (
                <ul className="absolute bg-white rounded shadow-lg mt-2 z-10 bg-[#fff]">
                  <li className="px-10 py-2 hover:bg-[#7F56D9] hover:text-white-300 cursor-pointer rounded-b-lg">
                    <Link href="/tcs">
                      <LinkScroll
                        activeClass="active"
                        to="tcs"
                  ...
                  <li className="px-10 py-2 hover:bg-[#7F56D9] hover:text-white-300 cursor-pointer rounded-b-lg">
                    <Link href="/infosys">
                      <LinkScroll
                        ...
                        smooth={true}
                        duration={1000}
                        onSetActive={() => setActiveLink("infosys")}
                      >
                        Infosys
                      </LinkScroll>
                    </Link>
      ...
      <nav className="fixed lg:hidden bottom-0 left-0 right-0 z-20 px-4 sm:px-8 shadow-t overflow-auto bg-white-500">
